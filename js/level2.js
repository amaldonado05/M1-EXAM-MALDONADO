export default class Level2 extends Phaser.Scene {
    ...
    create() {
        this.add.image(400, 300, 'level2_background').setDisplaySize(800, 600);

        const readyText = this.add.text(400, 300, 'Get Ready For Level 2', {
            fontSize: '48px',
            fill: '#ffffff',
            stroke: '#000000',
            strokeThickness: 5,
        ...
        this.platformRects = [];
        const createPlatform = (x, y, width, height, color = 0x8b0000) => {
        ...
        this.platformRects.push(createPlatform(200, 350, 150, 20));
        this.platformRects.push(createPlatform(450, 450, 150, 20));
        this.platformRects.push(createPlatform(400, 200, 150, 20));
        this.platformRects.push(createPlatform(700, 380, 150, 20));
        ...
        this.time.delayedCall(2000, () => {
            ...
            this.levelMusic = this.sound.add('level2_music', { loop: true, volume: 0.5 });
